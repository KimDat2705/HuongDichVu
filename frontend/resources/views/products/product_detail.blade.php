...
>>>>>>> 609e1928b7873fce4c5f14dd7c63902aa852c107
                                ...
                                <div class="tab-pane" id="pd-rev">
                                    <div class="pd-tab__rev">
                                        <div class="u-s-m-b-30">
                                            <div class="pd-tab__rev-score">
                                                <div class="u-s-m-b-8">
                                                    <h2 id="review-summary">0 Reviews - 0 (Overall)</h2>
                                                </div>
                                                <div id="review-stars" class="gl-rating-style-2 u-s-m-b-8"></div>
                                                <div class="u-s-m-b-8">
                                                    <h4>We want to hear from you!</h4>
                                                </div>
                                        ...
                                        <div class="u-s-m-b-30">
                                            <form class="pd-tab__rev-f1">
                                                ...
                                                <div class="rev-f1__review" id="review-list">
                                                    <!-- Reviews will be loaded here dynamically -->
                                                </div>
                                            </form>
                                        </div>
                                        <div class="u-s-m-b-30">
                                            <form class="pd-tab__rev-f2" id="review-form">
                                                <h2 class="u-s-m-b-15">Add a Review</h2>

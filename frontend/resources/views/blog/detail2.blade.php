        ...
        <div class="detail-post">
            <div class="bp-detail">
                ...
                <div class="bp-detail__info-wrap">
                    ...
                    <div class="blog-t-w">
                        <a class="gl-tag btn--e-transparent-hover-brand-b-2" href="{{ route('blog.SidebarNone') }}">Thiết kế</a>
                        <a class="gl-tag btn--e-transparent-hover-brand-b-2" href="{{ route('blog.SidebarNone') }}">Nội thất</a>
                    </div>

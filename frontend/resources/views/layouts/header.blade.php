                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Ghế bành phong cách đương đại</a>
                                                        </li>
                                                        <li>

                                                            <a href="{{ route('shop.side_v2') }}">Ghế văn phòng kiểu dáng tinh gọn</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Bàn làm việc tối giản</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Tủ quần áo hiện đại</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Tủ bếp không tay nắm</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Kệ treo tường dạng nổi</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Giường queen size hiện đại</a>
                                                        </li>
                                                        <li>

                                                            <a href="{{ route('shop.side_v2') }}">Giường có ngăn chứa đồ</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Ghế bành chạm khắc cổ điển</a>
                                                        </li>
                                                        <li>

                                                            <a href="{{ route('shop.side_v2') }}">Ghế thư giãn phong cách vintage</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Ghế trang trí phong cách Victorian</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Bàn ăn chạm khắc cổ điển</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Tủ sách phong cách vintage</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Kệ treo tường chạm khắc</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="{{ route('shop.side_v2') }}">Giường chạm khắc cổ điển</a>
                                                        </li>
                                                        <li>

                                                            <a href="{{ route('shop.side_v2') }}">Giường queen phong cách vintage</a>
                                                        </li>
                                                        <li>

                                                            <a href="{{ route('shop.side_v2') }}">Khung giường phong cách hoàng gia</a>
                                                        </li>
                                                        <li>
